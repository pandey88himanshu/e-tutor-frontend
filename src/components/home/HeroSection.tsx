  ...
  return (
    <section className="w-full bg-white">
      <div className="mx-auto max-w-480 px-4 sm:px-6 md:px-12 lg:px-16 xl:px-20 2xl:px-24">
        <div className="mx-auto max-w-480 px-4 sm:px-6 md:px-12 lg:px-16 xl:px-20 2xl:px-24">
          <div className="grid grid-cols-1 lg:grid-cols-2 min-h-[auto] lg:min-h-137 items-center">
            {/* LEFT CONTENT */}
            <div className="flex flex-col justify-center py-10 sm:py-12 lg:py-0 gap-4 sm:gap-5 lg:gap-6 order-2 lg:order-1">
